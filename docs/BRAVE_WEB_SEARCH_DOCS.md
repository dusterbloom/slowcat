...
Query Parameters 
https://api-dashboard.search.brave.com/app/documentation/web-search/query#LocalSearchAPIQueryParameters

Request Headers
https://api-dashboard.search.brave.com/app/documentation/web-search/request-headers#LocalSearchAPIRequestHeaders
