...
class PipelineBuilder:
    ...
    async def build_pipeline(self, webrtc_connection, language: str = "en", 
                           llm_model: str = None, stt_model: str = None, memo_model: str = None) -> Tuple[Pipeline, Any]:
        """
        ...
        services = await self._create_core_services(language, llm_model, stt_model, memo_model)
    ...
    async def _create_core_services(self, language: str, llm_model: str = None, stt_model: str = None, memo_model: str = None) -> Dict[str, Any]:
        ...
        # Create services
        services = await self.service_factory.create_services_for_language(language, llm_model, stt_model, memo_model)
